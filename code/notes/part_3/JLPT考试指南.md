...
除此之外，还可以参考各类网课和自己感兴趣的材料。在选择感兴趣的材料时，建议优先使用偏日常和正式的内容（如新闻、纪录片、日常番等），而不是过于中二的内容，以提升训练成果的泛用性。如果你不清楚每个等级对应的材料大概是什么难度，可以参考一下 [这篇文章](https://notes.sjtu.edu.cn/s/_t8ClOr7b#4-%E9%9A%BE%E5%BA%A6%E6%A0%B7%E4%BE%8B) 的第4章。
